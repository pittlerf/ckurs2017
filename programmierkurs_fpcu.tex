...
Wir haben einfachste Anweisungen kennen gelernt, die nacheinander ausgeführen waren. In diesem Teil werden wir wie kann mann die Reihenfolge 
der Ausführung ändern. Zum Bespiel wenn wir möchten das Absolutwert  eines Zahlen herausfinden, wir die Anweisung wird von dem Aktuellen Wert
...
Die Größer operator steht zwischen zwei Ganzen Zahl: das Ergebnis der Ausführung $a$ und $0$. Natürlich wissen wir das in diesem Fall das
...
Wert der Variable $a$ Negativ gewesen wäre, wäre die Anweisungen in der Block nach $else$ durchgefahren. Hier wir zeigen auch 
die Allgemeine Verwendung des if then else Statements.
